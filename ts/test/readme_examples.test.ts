...
//     (\`new EleringDashboardSDK(...)\` / \`EleringDashboardSDK.test(...)\` become
//     \`EleringDashboardSDK.test({ entity: ... })\`), transpiled to JS, and run
...
const SDK_NAME = 'EleringDashboardSDK'
...
const TEST_SEED = {"entity":{"balance":{"test01":{"id":"test01"}},"balance_controller":{"test01":{"id":"test01"}},"firm":{"test01":{"id":"test01"}},"firm_capacity_controller":{"test01":{"id":"test01"}},"gas_balance_controller":{"test01":{"id":"test01"}},"gas_border_trade_controller":{"test01":{"id":"test01"}},"gas_system":{"test01":{"id":"test01"}},"gas_system_controller":{"test01":{"id":"test01"}},"gas_trade":{"test01":{"id":"test01"}},"gas_trade_controller":{"test01":{"id":"test01"}},"gas_transmission_controller":{"test01":{"id":"test01"}},"green_controller":{"test01":{"id":"test01"}},"interruptible":{"test01":{"id":"test01"}},"interruptible_capacity_controller":{"test01":{"id":"test01"}},"nomination":{"test01":{"id":"test01"}},"nominations_controller":{"test01":{"id":"test01"}},"nps_controller":{"test01":{"id":"test01"}},"renomination":{"test01":{"id":"test01"}},"renominations_controller":{"test01":{"id":"test01"}},"system":{"test01":{"id":"test01"}},"system_controller":{"test01":{"id":"test01"}},"transmission_controller":{"test01":{"id":"test01"}},"umm_gas_controller":{"test01":{"id":"test01"}},"umm_rss_feed_controller":{"test01":{"id":"test01"}}}}
...
// rewrite real client construction (\`new EleringDashboardSDK(...)\` and any
// \`EleringDashboardSDK.test(...)\`) to a seeded test-mode client, and give
...
function rewriteForRun(code: string): string {
  ...
  out = out.replace(/new\s+EleringDashboardSDK\s*\([^)]*\)/g, () => SEEDED_CTOR)
  out = out.replace(/EleringDashboardSDK\.test\s*\([^)]*\)/g, () => SEEDED_CTOR)
