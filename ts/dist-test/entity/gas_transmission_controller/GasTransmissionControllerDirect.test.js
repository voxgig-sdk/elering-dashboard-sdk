...
(0, node_test_1.describe)('GasTransmissionControllerDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-gas_transmission_controller', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-gas_transmission_controller', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['ELERING_DASHBOARD_TEST_GAS_TRANSMISSION_CONTROLLER_ENTID'];
...
//# sourceMappingURL=GasTransmissionControllerDirect.test.js.map