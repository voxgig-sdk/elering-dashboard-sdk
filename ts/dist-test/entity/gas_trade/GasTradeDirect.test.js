...
(0, node_test_1.describe)('GasTradeDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-gas_trade', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-gas_trade', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['ELERING_DASHBOARD_TEST_GAS_TRADE_ENTID'];
...
//# sourceMappingURL=GasTradeDirect.test.js.map