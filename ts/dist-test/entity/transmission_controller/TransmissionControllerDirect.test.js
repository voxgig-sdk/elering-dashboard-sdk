...
(0, node_test_1.describe)('TransmissionControllerDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-transmission_controller', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-transmission_controller', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'ELERING_DASHBOARD_TEST_TRANSMISSION_CONTROLLER_ENTID': {},
    ...
    if (live) {
        ...
        let idmap = env['ELERING_DASHBOARD_TEST_TRANSMISSION_CONTROLLER_ENTID'];
...
//# sourceMappingURL=TransmissionControllerDirect.test.js.map