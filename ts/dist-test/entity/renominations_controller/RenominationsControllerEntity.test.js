...
(0, node_test_1.describe)('RenominationsControllerEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'renominations_controller.' + op, live))
                return;
        }
        ...
        let renominations_controller_ref01_data = Object.values(setup.data.existing.renominations_controller)[0];
        // LOAD
        const renominations_controller_ref01_ent = client.RenominationsController();
        const renominations_controller_ref01_match_dt0 = {};
        ...
        (0, node_assert_1.default)(null != renominations_controller_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/renominations_controller/RenominationsControllerTestData.json');
    ...
    let idmap = transform(['renominations_controller01', 'renominations_controller02', 'renominations_controller03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['ELERING_DASHBOARD_TEST_RENOMINATIONS_CONTROLLER_ENTID'];
...
//# sourceMappingURL=RenominationsControllerEntity.test.js.map