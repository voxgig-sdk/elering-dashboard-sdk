...
(0, node_test_1.describe)('BalanceControllerEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'balance_controller.' + op, live))
                return;
        }
        ...
        let balance_controller_ref01_data = Object.values(setup.data.existing.balance_controller)[0];
        // LOAD
        const balance_controller_ref01_ent = client.BalanceController();
        const balance_controller_ref01_match_dt0 = {};
        const balance_controller_ref01_data_dt0 = (await balance_controller_ref01_ent.load(balance_controller_ref01_match_dt0)).data();
        (0, node_assert_1.default)(null != balance_controller_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/balance_controller/BalanceControllerTestData.json');
    ...
    let idmap = transform(['balance_controller01', 'balance_controller02', 'balance_controller03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['ELERING_DASHBOARD_TEST_BALANCE_CONTROLLER_ENTID'];
...
//# sourceMappingURL=BalanceControllerEntity.test.js.map