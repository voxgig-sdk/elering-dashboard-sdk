...
(0, node_test_1.describe)('InterruptibleCapacityControllerDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.EleringDashboardSDK({
    ...
    (0, node_test_1.test)('direct-load-interruptible_capacity_controller', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-interruptible_capacity_controller', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.ELERING_DASHBOARD_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.EleringDashboardSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['ELERING_DASHBOARD_TEST_INTERRUPTIBLE_CAPACITY_CONTROLLER_ENTID'];
    ...
    const client = new __1.EleringDashboardSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=InterruptibleCapacityControllerDirect.test.js.map