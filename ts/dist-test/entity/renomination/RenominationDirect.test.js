...
(0, node_test_1.describe)('RenominationDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-renomination', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-renomination', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['ELERING_DASHBOARD_TEST_RENOMINATION_ENTID'];
...
//# sourceMappingURL=RenominationDirect.test.js.map