...
(0, node_test_1.describe)('FirmCapacityControllerDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-firm_capacity_controller', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-firm_capacity_controller', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['ELERING_DASHBOARD_TEST_FIRM_CAPACITY_CONTROLLER_ENTID'];
...
//# sourceMappingURL=FirmCapacityControllerDirect.test.js.map