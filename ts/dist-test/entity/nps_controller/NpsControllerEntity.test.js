...
(0, node_test_1.describe)('NpsControllerEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'nps_controller.' + op, live))
                return;
        }
        ...
        let nps_controller_ref01_data = Object.values(setup.data.existing.nps_controller)[0];
        // LOAD
        const nps_controller_ref01_ent = client.NpsController();
        const nps_controller_ref01_match_dt0 = {};
        const nps_controller_ref01_data_dt0 = (await nps_controller_ref01_ent.load(nps_controller_ref01_match_dt0)).data();
        (0, node_assert_1.default)(null != nps_controller_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/nps_controller/NpsControllerTestData.json');
    ...
    let idmap = transform(['nps_controller01', 'nps_controller02', 'nps_controller03', 'price01', 'price02', 'price03', 'turnover01', 'turnover02', 'turnover03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=NpsControllerEntity.test.js.map