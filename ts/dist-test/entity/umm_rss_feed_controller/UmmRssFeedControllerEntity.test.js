...
(0, node_test_1.describe)('UmmRssFeedControllerEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'umm_rss_feed_controller.' + op, live))
                return;
        }
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set ELERING_DASHBOARD_TEST_UMM_RSS_FEED_CONTROLLER_ENTID JSON to run live');
            return;
        }
        ...
        let umm_rss_feed_controller_ref01_data = Object.values(setup.data.existing.umm_rss_feed_controller)[0];
        // LOAD
        const umm_rss_feed_controller_ref01_ent = client.UmmRssFeedController();
        const umm_rss_feed_controller_ref01_match_dt0 = {};
        ...
        (0, node_assert_1.default)(null != umm_rss_feed_controller_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/umm_rss_feed_controller/UmmRssFeedControllerTestData.json');
    ...
    let idmap = transform(['umm_rss_feed_controller01', 'umm_rss_feed_controller02', 'umm_rss_feed_controller03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['ELERING_DASHBOARD_TEST_UMM_RSS_FEED_CONTROLLER_ENTID'];
...
//# sourceMappingURL=UmmRssFeedControllerEntity.test.js.map