...
(0, node_test_1.describe)('GasTradeControllerEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'gas_trade_controller.' + op, live))
                return;
        }
        ...
        let gas_trade_controller_ref01_data = Object.values(setup.data.existing.gas_trade_controller)[0];
        // LOAD
        const gas_trade_controller_ref01_ent = client.GasTradeController();
        const gas_trade_controller_ref01_match_dt0 = {};
        ...
        (0, node_assert_1.default)(null != gas_trade_controller_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/gas_trade_controller/GasTradeControllerTestData.json');
    ...
    let idmap = transform(['gas_trade_controller01', 'gas_trade_controller02', 'gas_trade_controller03', 'gas_trade01', 'gas_trade02', 'gas_trade03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=GasTradeControllerEntity.test.js.map