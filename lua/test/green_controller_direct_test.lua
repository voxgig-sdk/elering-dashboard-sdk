...
describe("GreenControllerDirect", function()
  it("should direct-load-green_controller", function()
    local setup = green_controller_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-green_controller", setup.live and "live" or "unit")
...
function green_controller_direct_setup(mockres)
