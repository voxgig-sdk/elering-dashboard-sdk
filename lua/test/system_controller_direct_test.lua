...
describe("SystemControllerDirect", function()
  it("should direct-load-system_controller", function()
    local setup = system_controller_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-system_controller", setup.live and "live" or "unit")
...
function system_controller_direct_setup(mockres)
