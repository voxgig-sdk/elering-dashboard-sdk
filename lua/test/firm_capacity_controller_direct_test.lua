-- FirmCapacityController direct test
...
describe("FirmCapacityControllerDirect", function()
  it("should direct-load-firm_capacity_controller", function()
    local setup = firm_capacity_controller_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-firm_capacity_controller", setup.live and "live" or "unit")
...
function firm_capacity_controller_direct_setup(mockres)
