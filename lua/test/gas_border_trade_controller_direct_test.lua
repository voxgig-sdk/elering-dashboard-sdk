-- GasBorderTradeController direct test
...
describe("GasBorderTradeControllerDirect", function()
  it("should direct-load-gas_border_trade_controller", function()
    local setup = gas_border_trade_controller_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-gas_border_trade_controller", setup.live and "live" or "unit")
...
function gas_border_trade_controller_direct_setup(mockres)
