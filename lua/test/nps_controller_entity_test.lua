...
describe("NpsControllerEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set ELERING_DASHBOARD_TEST_NPS_CONTROLLER_ENTID JSON to run live")
      return
    end
...
function nps_controller_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("ELERING_DASHBOARD_TEST_NPS_CONTROLLER_ENTID")
