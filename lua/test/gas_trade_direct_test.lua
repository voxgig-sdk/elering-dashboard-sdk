...
describe("GasTradeDirect", function()
  it("should direct-load-gas_trade", function()
    local setup = gas_trade_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-gas_trade", setup.live and "live" or "unit")
...
function gas_trade_direct_setup(mockres)
