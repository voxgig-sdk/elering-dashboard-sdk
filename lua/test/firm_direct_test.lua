...
describe("FirmDirect", function()
  it("should direct-load-firm", function()
    local setup = firm_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-firm", setup.live and "live" or "unit")
...
function firm_direct_setup(mockres)
