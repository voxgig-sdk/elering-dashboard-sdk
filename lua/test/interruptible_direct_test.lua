...
describe("InterruptibleDirect", function()
  it("should direct-load-interruptible", function()
    local setup = interruptible_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-interruptible", setup.live and "live" or "unit")
...
function interruptible_direct_setup(mockres)
