...
describe("NpsControllerDirect", function()
  it("should direct-load-nps_controller", function()
    local setup = nps_controller_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-nps_controller", setup.live and "live" or "unit")
...
function nps_controller_direct_setup(mockres)
