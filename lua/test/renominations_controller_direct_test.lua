-- RenominationsController direct test
...
describe("RenominationsControllerDirect", function()
  it("should direct-load-renominations_controller", function()
    local setup = renominations_controller_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-renominations_controller", setup.live and "live" or "unit")
...
function renominations_controller_direct_setup(mockres)
