...
describe("UmmGasControllerDirect", function()
  it("should direct-load-umm_gas_controller", function()
    local setup = umm_gas_controller_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-umm_gas_controller", setup.live and "live" or "unit")
...
function umm_gas_controller_direct_setup(mockres)
