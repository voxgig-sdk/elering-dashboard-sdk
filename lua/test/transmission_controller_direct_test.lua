-- TransmissionController direct test
...
describe("TransmissionControllerDirect", function()
  it("should direct-load-transmission_controller", function()
    local setup = transmission_controller_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-transmission_controller", setup.live and "live" or "unit")
...
function transmission_controller_direct_setup(mockres)
