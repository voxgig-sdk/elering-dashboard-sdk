...
function runner.env_override(m)
  local live = runner.getenv("ELERING_DASHBOARD_TEST_LIVE")
  local override = runner.getenv("ELERING_DASHBOARD_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("ELERING_DASHBOARD_TEST_EXPLAIN")
