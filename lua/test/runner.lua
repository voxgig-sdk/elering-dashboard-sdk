...
function runner.env_override(m)
  local live = runner.getenv("ELERINGDASHBOARD_TEST_LIVE")
  local override = runner.getenv("ELERINGDASHBOARD_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("ELERINGDASHBOARD_TEST_EXPLAIN")
