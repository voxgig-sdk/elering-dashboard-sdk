-- InterruptibleCapacityController direct test
...
describe("InterruptibleCapacityControllerDirect", function()
  it("should direct-load-interruptible_capacity_controller", function()
    local setup = interruptible_capacity_controller_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-interruptible_capacity_controller", setup.live and "live" or "unit")
...
function interruptible_capacity_controller_direct_setup(mockres)
