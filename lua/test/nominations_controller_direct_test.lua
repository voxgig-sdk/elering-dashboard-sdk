-- NominationsController direct test
...
describe("NominationsControllerDirect", function()
  it("should direct-load-nominations_controller", function()
    local setup = nominations_controller_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-nominations_controller", setup.live and "live" or "unit")
...
function nominations_controller_direct_setup(mockres)
