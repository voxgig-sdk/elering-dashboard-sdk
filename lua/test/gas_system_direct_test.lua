...
describe("GasSystemDirect", function()
  it("should direct-load-gas_system", function()
    local setup = gas_system_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-gas_system", setup.live and "live" or "unit")
...
function gas_system_direct_setup(mockres)
