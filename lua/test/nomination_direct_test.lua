...
describe("NominationDirect", function()
  it("should direct-load-nomination", function()
    local setup = nomination_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-nomination", setup.live and "live" or "unit")
...
function nomination_direct_setup(mockres)
