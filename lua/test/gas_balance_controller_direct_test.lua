-- GasBalanceController direct test
...
describe("GasBalanceControllerDirect", function()
  it("should direct-load-gas_balance_controller", function()
    local setup = gas_balance_controller_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-gas_balance_controller", setup.live and "live" or "unit")
...
function gas_balance_controller_direct_setup(mockres)
