-- UmmRssFeedController direct test
...
describe("UmmRssFeedControllerDirect", function()
  it("should direct-load-umm_rss_feed_controller", function()
    local setup = umm_rss_feed_controller_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-umm_rss_feed_controller", setup.live and "live" or "unit")
...
function umm_rss_feed_controller_direct_setup(mockres)
