...
describe("GasTransmissionControllerEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set ELERING_DASHBOARD_TEST_GAS_TRANSMISSION_CONTROLLER_ENTID JSON to run live")
      return
    end
...
function gas_transmission_controller_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("ELERING_DASHBOARD_TEST_GAS_TRANSMISSION_CONTROLLER_ENTID")
