...
describe("BalanceControllerDirect", function()
  it("should direct-load-balance_controller", function()
    local setup = balance_controller_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-balance_controller", setup.live and "live" or "unit")
...
function balance_controller_direct_setup(mockres)
