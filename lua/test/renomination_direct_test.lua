...
describe("RenominationDirect", function()
  it("should direct-load-renomination", function()
    local setup = renomination_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-renomination", setup.live and "live" or "unit")
...
function renomination_direct_setup(mockres)
