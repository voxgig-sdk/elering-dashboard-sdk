...
local GasTradeControllerEntity = {}
GasTradeControllerEntity.__index = GasTradeControllerEntity


function GasTradeControllerEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GasTradeControllerEntity)
  self._name = "gas_trade_controller"
  self._client = client
...
function GasTradeControllerEntity:get_name()
  return self._name
end


function GasTradeControllerEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GasTradeControllerEntity.new(self._client, opts)
end
...
function GasTradeControllerEntity:mark_deleted()
  self._deleted = true
end


function GasTradeControllerEntity:deleted()
  return true == self._deleted
end


function GasTradeControllerEntity:data_set(args)
  if args ~= nil then
...
function GasTradeControllerEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GasTradeControllerEntity:match_set(args)
  if args ~= nil then
...
function GasTradeControllerEntity:match_get()
...
function GasTradeControllerEntity:stream(action, args, callopts)
...
---@param reqmatch GasTradeControllerLoadMatch
---@param ctrl? table
---@return GasTradeController
---@return string? err
function GasTradeControllerEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function GasTradeControllerEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return GasTradeControllerEntity
