...
local GasBorderTradeControllerEntity = {}
GasBorderTradeControllerEntity.__index = GasBorderTradeControllerEntity


function GasBorderTradeControllerEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GasBorderTradeControllerEntity)
  self._name = "gas_border_trade_controller"
  self._client = client
...
function GasBorderTradeControllerEntity:get_name()
  return self._name
end


function GasBorderTradeControllerEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GasBorderTradeControllerEntity.new(self._client, opts)
end
...
function GasBorderTradeControllerEntity:mark_deleted()
  self._deleted = true
end


function GasBorderTradeControllerEntity:deleted()
  return true == self._deleted
end


function GasBorderTradeControllerEntity:data_set(args)
  if args ~= nil then
...
function GasBorderTradeControllerEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GasBorderTradeControllerEntity:match_set(args)
  if args ~= nil then
...
function GasBorderTradeControllerEntity:match_get()
...
function GasBorderTradeControllerEntity:stream(action, args, callopts)
...
---@param reqmatch GasBorderTradeControllerLoadMatch
---@param ctrl? table
---@return GasBorderTradeController
---@return string? err
function GasBorderTradeControllerEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function GasBorderTradeControllerEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return GasBorderTradeControllerEntity
