...
local SystemControllerEntity = {}
SystemControllerEntity.__index = SystemControllerEntity


function SystemControllerEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, SystemControllerEntity)
  self._name = "system_controller"
  self._client = client
...
function SystemControllerEntity:get_name()
  return self._name
end


function SystemControllerEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return SystemControllerEntity.new(self._client, opts)
end
...
function SystemControllerEntity:mark_deleted()
  self._deleted = true
end


function SystemControllerEntity:deleted()
  return true == self._deleted
end


function SystemControllerEntity:data_set(args)
  if args ~= nil then
...
function SystemControllerEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function SystemControllerEntity:match_set(args)
  if args ~= nil then
...
function SystemControllerEntity:match_get()
...
function SystemControllerEntity:stream(action, args, callopts)
...
---@param reqmatch SystemControllerLoadMatch
---@param ctrl? table
---@return SystemController
---@return string? err
function SystemControllerEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function SystemControllerEntity:_run_op(ctx, post_done)
  local utility = self._utility
