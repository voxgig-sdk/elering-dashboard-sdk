...
local GasTransmissionControllerEntity = {}
GasTransmissionControllerEntity.__index = GasTransmissionControllerEntity


function GasTransmissionControllerEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GasTransmissionControllerEntity)
  self._name = "gas_transmission_controller"
  self._client = client
...
function GasTransmissionControllerEntity:get_name()
  return self._name
end


function GasTransmissionControllerEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GasTransmissionControllerEntity.new(self._client, opts)
end
...
function GasTransmissionControllerEntity:mark_deleted()
  self._deleted = true
end


function GasTransmissionControllerEntity:deleted()
  return true == self._deleted
end


function GasTransmissionControllerEntity:data_set(args)
  if args ~= nil then
...
function GasTransmissionControllerEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GasTransmissionControllerEntity:match_set(args)
  if args ~= nil then
...
function GasTransmissionControllerEntity:match_get()
...
function GasTransmissionControllerEntity:stream(action, args, callopts)
...
---@param reqmatch GasTransmissionControllerLoadMatch
---@param ctrl? table
---@return GasTransmissionController
---@return string? err
function GasTransmissionControllerEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function GasTransmissionControllerEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return GasTransmissionControllerEntity
