...
local GreenControllerEntity = {}
GreenControllerEntity.__index = GreenControllerEntity


function GreenControllerEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GreenControllerEntity)
  self._name = "green_controller"
  self._client = client
...
function GreenControllerEntity:get_name()
  return self._name
end


function GreenControllerEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GreenControllerEntity.new(self._client, opts)
end
...
function GreenControllerEntity:mark_deleted()
  self._deleted = true
end


function GreenControllerEntity:deleted()
  return true == self._deleted
end


function GreenControllerEntity:data_set(args)
  if args ~= nil then
...
function GreenControllerEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GreenControllerEntity:match_set(args)
  if args ~= nil then
...
function GreenControllerEntity:match_get()
...
function GreenControllerEntity:stream(action, args, callopts)
...
function GreenControllerEntity:_run_op(ctx, post_done)
  local utility = self._utility
