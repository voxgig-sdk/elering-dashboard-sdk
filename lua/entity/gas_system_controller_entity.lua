...
local GasSystemControllerEntity = {}
GasSystemControllerEntity.__index = GasSystemControllerEntity


function GasSystemControllerEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GasSystemControllerEntity)
  self._name = "gas_system_controller"
  self._client = client
...
function GasSystemControllerEntity:get_name()
  return self._name
end


function GasSystemControllerEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GasSystemControllerEntity.new(self._client, opts)
end
...
function GasSystemControllerEntity:mark_deleted()
  self._deleted = true
end


function GasSystemControllerEntity:deleted()
  return true == self._deleted
end


function GasSystemControllerEntity:data_set(args)
  if args ~= nil then
...
function GasSystemControllerEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GasSystemControllerEntity:match_set(args)
  if args ~= nil then
...
function GasSystemControllerEntity:match_get()
...
function GasSystemControllerEntity:stream(action, args, callopts)
...
function GasSystemControllerEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return GasSystemControllerEntity
