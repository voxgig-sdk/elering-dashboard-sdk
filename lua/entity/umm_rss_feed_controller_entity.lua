...
local UmmRssFeedControllerEntity = {}
UmmRssFeedControllerEntity.__index = UmmRssFeedControllerEntity


function UmmRssFeedControllerEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, UmmRssFeedControllerEntity)
  self._name = "umm_rss_feed_controller"
  self._client = client
...
function UmmRssFeedControllerEntity:get_name()
  return self._name
end


function UmmRssFeedControllerEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return UmmRssFeedControllerEntity.new(self._client, opts)
end
...
function UmmRssFeedControllerEntity:mark_deleted()
  self._deleted = true
end


function UmmRssFeedControllerEntity:deleted()
  return true == self._deleted
end


function UmmRssFeedControllerEntity:data_set(args)
  if args ~= nil then
...
function UmmRssFeedControllerEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function UmmRssFeedControllerEntity:match_set(args)
  if args ~= nil then
...
function UmmRssFeedControllerEntity:match_get()
...
function UmmRssFeedControllerEntity:stream(action, args, callopts)
...
---@param reqmatch UmmRssFeedControllerLoadMatch
---@param ctrl? table
---@return UmmRssFeedController
---@return string? err
function UmmRssFeedControllerEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function UmmRssFeedControllerEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return UmmRssFeedControllerEntity
