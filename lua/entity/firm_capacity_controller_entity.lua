...
local FirmCapacityControllerEntity = {}
FirmCapacityControllerEntity.__index = FirmCapacityControllerEntity


function FirmCapacityControllerEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, FirmCapacityControllerEntity)
  self._name = "firm_capacity_controller"
  self._client = client
...
function FirmCapacityControllerEntity:get_name()
  return self._name
end


function FirmCapacityControllerEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return FirmCapacityControllerEntity.new(self._client, opts)
end
...
function FirmCapacityControllerEntity:mark_deleted()
  self._deleted = true
end


function FirmCapacityControllerEntity:deleted()
  return true == self._deleted
end


function FirmCapacityControllerEntity:data_set(args)
  if args ~= nil then
...
function FirmCapacityControllerEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function FirmCapacityControllerEntity:match_set(args)
  if args ~= nil then
...
function FirmCapacityControllerEntity:match_get()
...
function FirmCapacityControllerEntity:stream(action, args, callopts)
...
---@param reqmatch FirmCapacityControllerLoadMatch
---@param ctrl? table
---@return FirmCapacityController
---@return string? err
function FirmCapacityControllerEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function FirmCapacityControllerEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return FirmCapacityControllerEntity
