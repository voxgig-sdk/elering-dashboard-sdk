...
local UmmGasControllerEntity = {}
UmmGasControllerEntity.__index = UmmGasControllerEntity


function UmmGasControllerEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, UmmGasControllerEntity)
  self._name = "umm_gas_controller"
  self._client = client
...
function UmmGasControllerEntity:get_name()
  return self._name
end


function UmmGasControllerEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return UmmGasControllerEntity.new(self._client, opts)
end
...
function UmmGasControllerEntity:mark_deleted()
  self._deleted = true
end


function UmmGasControllerEntity:deleted()
  return true == self._deleted
end


function UmmGasControllerEntity:data_set(args)
  if args ~= nil then
...
function UmmGasControllerEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function UmmGasControllerEntity:match_set(args)
  if args ~= nil then
...
function UmmGasControllerEntity:match_get()
...
function UmmGasControllerEntity:stream(action, args, callopts)
...
---@param reqmatch UmmGasControllerLoadMatch
---@param ctrl? table
---@return UmmGasController
---@return string? err
function UmmGasControllerEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function UmmGasControllerEntity:_run_op(ctx, post_done)
  local utility = self._utility
