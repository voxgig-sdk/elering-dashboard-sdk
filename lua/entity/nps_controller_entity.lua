...
local NpsControllerEntity = {}
NpsControllerEntity.__index = NpsControllerEntity


function NpsControllerEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, NpsControllerEntity)
  self._name = "nps_controller"
  self._client = client
...
function NpsControllerEntity:get_name()
  return self._name
end


function NpsControllerEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return NpsControllerEntity.new(self._client, opts)
end
...
function NpsControllerEntity:mark_deleted()
  self._deleted = true
end


function NpsControllerEntity:deleted()
  return true == self._deleted
end


function NpsControllerEntity:data_set(args)
  if args ~= nil then
...
function NpsControllerEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function NpsControllerEntity:match_set(args)
  if args ~= nil then
...
function NpsControllerEntity:match_get()
...
function NpsControllerEntity:stream(action, args, callopts)
...
function NpsControllerEntity:_run_op(ctx, post_done)
  local utility = self._utility
