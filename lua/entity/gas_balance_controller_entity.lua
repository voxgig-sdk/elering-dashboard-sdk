...
local GasBalanceControllerEntity = {}
GasBalanceControllerEntity.__index = GasBalanceControllerEntity


function GasBalanceControllerEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GasBalanceControllerEntity)
  self._name = "gas_balance_controller"
  self._client = client
...
function GasBalanceControllerEntity:get_name()
  return self._name
end


function GasBalanceControllerEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GasBalanceControllerEntity.new(self._client, opts)
end
...
function GasBalanceControllerEntity:mark_deleted()
  self._deleted = true
end


function GasBalanceControllerEntity:deleted()
  return true == self._deleted
end


function GasBalanceControllerEntity:data_set(args)
  if args ~= nil then
...
function GasBalanceControllerEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GasBalanceControllerEntity:match_set(args)
  if args ~= nil then
...
function GasBalanceControllerEntity:match_get()
...
function GasBalanceControllerEntity:stream(action, args, callopts)
...
---@param reqmatch GasBalanceControllerLoadMatch
---@param ctrl? table
---@return GasBalanceController
---@return string? err
function GasBalanceControllerEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function GasBalanceControllerEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return GasBalanceControllerEntity
