...
local NominationEntity = {}
NominationEntity.__index = NominationEntity


function NominationEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, NominationEntity)
  self._name = "nomination"
  self._client = client
...
function NominationEntity:get_name()
  return self._name
end


function NominationEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return NominationEntity.new(self._client, opts)
end
...
function NominationEntity:mark_deleted()
  self._deleted = true
end


function NominationEntity:deleted()
  return true == self._deleted
end


function NominationEntity:data_set(args)
  if args ~= nil then
...
function NominationEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function NominationEntity:match_set(args)
  if args ~= nil then
...
function NominationEntity:match_get()
...
function NominationEntity:stream(action, args, callopts)
...
---@param reqmatch NominationLoadMatch
---@param ctrl? table
---@return Nomination
---@return string? err
function NominationEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function NominationEntity:_run_op(ctx, post_done)
  local utility = self._utility
