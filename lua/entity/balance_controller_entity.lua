...
local BalanceControllerEntity = {}
BalanceControllerEntity.__index = BalanceControllerEntity


function BalanceControllerEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, BalanceControllerEntity)
  self._name = "balance_controller"
  self._client = client
...
function BalanceControllerEntity:get_name()
  return self._name
end


function BalanceControllerEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return BalanceControllerEntity.new(self._client, opts)
end
...
function BalanceControllerEntity:mark_deleted()
  self._deleted = true
end


function BalanceControllerEntity:deleted()
  return true == self._deleted
end


function BalanceControllerEntity:data_set(args)
  if args ~= nil then
...
function BalanceControllerEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function BalanceControllerEntity:match_set(args)
  if args ~= nil then
...
function BalanceControllerEntity:match_get()
...
function BalanceControllerEntity:stream(action, args, callopts)
...
---@param reqmatch BalanceControllerLoadMatch
---@param ctrl? table
---@return BalanceController
---@return string? err
function BalanceControllerEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function BalanceControllerEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return BalanceControllerEntity
