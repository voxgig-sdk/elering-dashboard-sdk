...
local TransmissionControllerEntity = {}
TransmissionControllerEntity.__index = TransmissionControllerEntity


function TransmissionControllerEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, TransmissionControllerEntity)
  self._name = "transmission_controller"
  self._client = client
...
function TransmissionControllerEntity:get_name()
  return self._name
end


function TransmissionControllerEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return TransmissionControllerEntity.new(self._client, opts)
end
...
function TransmissionControllerEntity:mark_deleted()
  self._deleted = true
end


function TransmissionControllerEntity:deleted()
  return true == self._deleted
end


function TransmissionControllerEntity:data_set(args)
  if args ~= nil then
...
function TransmissionControllerEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function TransmissionControllerEntity:match_set(args)
  if args ~= nil then
...
function TransmissionControllerEntity:match_get()
...
function TransmissionControllerEntity:stream(action, args, callopts)
...
function TransmissionControllerEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return TransmissionControllerEntity
