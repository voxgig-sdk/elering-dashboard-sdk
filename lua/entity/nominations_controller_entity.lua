...
local NominationsControllerEntity = {}
NominationsControllerEntity.__index = NominationsControllerEntity


function NominationsControllerEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, NominationsControllerEntity)
  self._name = "nominations_controller"
  self._client = client
...
function NominationsControllerEntity:get_name()
  return self._name
end


function NominationsControllerEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return NominationsControllerEntity.new(self._client, opts)
end
...
function NominationsControllerEntity:mark_deleted()
  self._deleted = true
end


function NominationsControllerEntity:deleted()
  return true == self._deleted
end


function NominationsControllerEntity:data_set(args)
  if args ~= nil then
...
function NominationsControllerEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function NominationsControllerEntity:match_set(args)
  if args ~= nil then
...
function NominationsControllerEntity:match_get()
...
function NominationsControllerEntity:stream(action, args, callopts)
...
function NominationsControllerEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return NominationsControllerEntity
