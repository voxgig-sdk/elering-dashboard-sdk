...
function RenominationsControllerEntity:mark_deleted()
  self._deleted = true
end


function RenominationsControllerEntity:deleted()
...
function RenominationsControllerEntity:stream(action, args, callopts)
