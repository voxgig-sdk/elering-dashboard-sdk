...
// instead of `sdk.NewEleringDashboardSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *EleringDashboardSDK  { return NewEleringDashboardSDK(nil) }
func Test() *EleringDashboardSDK { return TestSDK(nil, nil) }
