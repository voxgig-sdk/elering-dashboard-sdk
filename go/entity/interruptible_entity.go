...
type InterruptibleEntity struct {
	name    string
...
func NewInterruptibleEntity(client *core.EleringDashboardSDK, entopts map[string]any) *InterruptibleEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *InterruptibleEntity) GetName() string { return e.name }
...
func (e *InterruptibleEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *InterruptibleEntity) Deleted() bool {
	return e.deleted
}


func (e *InterruptibleEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewInterruptibleEntity(e.client, opts)
}

func (e *InterruptibleEntity) Data(args ...any) any {
...
func (e *InterruptibleEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Interruptible; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *InterruptibleEntity) DataTyped(data ...Interruptible) Interruptible {
	if len(data) > 0 {
		return typedFrom[Interruptible](e.Data(asMap(data[0])))
	}
	return typedFrom[Interruptible](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Interruptible (all fields
// optional at the wire level).
func (e *InterruptibleEntity) MatchTyped(match ...Interruptible) Interruptible {
	if len(match) > 0 {
		return typedFrom[Interruptible](e.Match(asMap(match[0])))
	}
	return typedFrom[Interruptible](e.Match())
}
...
func (e *InterruptibleEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *InterruptibleEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// InterruptibleLoadMatch and returns an Interruptible. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *InterruptibleEntity) LoadTyped(reqmatch InterruptibleLoadMatch, ctrl map[string]any) (Interruptible, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Interruptible{}, err
	}
	return typedFrom[Interruptible](res), nil
}



func (e *InterruptibleEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *InterruptibleEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *InterruptibleEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *InterruptibleEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *InterruptibleEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
