...
type GasTradeControllerEntity struct {
	name    string
...
func NewGasTradeControllerEntity(client *core.EleringDashboardSDK, entopts map[string]any) *GasTradeControllerEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GasTradeControllerEntity) GetName() string { return e.name }
...
func (e *GasTradeControllerEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GasTradeControllerEntity) Deleted() bool {
	return e.deleted
}


func (e *GasTradeControllerEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGasTradeControllerEntity(e.client, opts)
}

func (e *GasTradeControllerEntity) Data(args ...any) any {
...
func (e *GasTradeControllerEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GasTradeController; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GasTradeControllerEntity) DataTyped(data ...GasTradeController) GasTradeController {
	if len(data) > 0 {
		return typedFrom[GasTradeController](e.Data(asMap(data[0])))
	}
	return typedFrom[GasTradeController](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GasTradeController (all fields
// optional at the wire level).
func (e *GasTradeControllerEntity) MatchTyped(match ...GasTradeController) GasTradeController {
	if len(match) > 0 {
		return typedFrom[GasTradeController](e.Match(asMap(match[0])))
	}
	return typedFrom[GasTradeController](e.Match())
}
...
func (e *GasTradeControllerEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GasTradeControllerEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GasTradeControllerLoadMatch and returns an GasTradeController. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *GasTradeControllerEntity) LoadTyped(reqmatch GasTradeControllerLoadMatch, ctrl map[string]any) (GasTradeController, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return GasTradeController{}, err
	}
	return typedFrom[GasTradeController](res), nil
}



func (e *GasTradeControllerEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *GasTradeControllerEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GasTradeControllerEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GasTradeControllerEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GasTradeControllerEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
