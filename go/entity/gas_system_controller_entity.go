...
type GasSystemControllerEntity struct {
	name    string
...
func NewGasSystemControllerEntity(client *core.EleringDashboardSDK, entopts map[string]any) *GasSystemControllerEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GasSystemControllerEntity) GetName() string { return e.name }
...
func (e *GasSystemControllerEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GasSystemControllerEntity) Deleted() bool {
	return e.deleted
}


func (e *GasSystemControllerEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGasSystemControllerEntity(e.client, opts)
}

func (e *GasSystemControllerEntity) Data(args ...any) any {
...
func (e *GasSystemControllerEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GasSystemController; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GasSystemControllerEntity) DataTyped(data ...GasSystemController) GasSystemController {
	if len(data) > 0 {
		return typedFrom[GasSystemController](e.Data(asMap(data[0])))
	}
	return typedFrom[GasSystemController](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GasSystemController (all fields
// optional at the wire level).
func (e *GasSystemControllerEntity) MatchTyped(match ...GasSystemController) GasSystemController {
	if len(match) > 0 {
		return typedFrom[GasSystemController](e.Match(asMap(match[0])))
	}
	return typedFrom[GasSystemController](e.Match())
}
...
func (e *GasSystemControllerEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GasSystemControllerEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GasSystemControllerLoadMatch and returns an GasSystemController. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *GasSystemControllerEntity) LoadTyped(reqmatch GasSystemControllerLoadMatch, ctrl map[string]any) (GasSystemController, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return GasSystemController{}, err
	}
	return typedFrom[GasSystemController](res), nil
}



func (e *GasSystemControllerEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *GasSystemControllerEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GasSystemControllerEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GasSystemControllerEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GasSystemControllerEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
