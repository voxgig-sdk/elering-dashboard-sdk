...
func NewFirmEntity(client *core.EleringDashboardSDK, entopts map[string]any) *FirmEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *FirmEntity) GetName() string { return e.name }
...
func (e *FirmEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *FirmEntity) Deleted() bool {
	return e.deleted
}


func (e *FirmEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewFirmEntity(e.client, opts)
}

func (e *FirmEntity) Data(args ...any) any {
...
func (e *FirmEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Firm; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *FirmEntity) DataTyped(data ...Firm) Firm {
	if len(data) > 0 {
		return typedFrom[Firm](e.Data(asMap(data[0])))
	}
	return typedFrom[Firm](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Firm (all fields
// optional at the wire level).
func (e *FirmEntity) MatchTyped(match ...Firm) Firm {
	if len(match) > 0 {
		return typedFrom[Firm](e.Match(asMap(match[0])))
	}
	return typedFrom[Firm](e.Match())
}
...
func (e *FirmEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *FirmEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// FirmLoadMatch and returns an Firm. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *FirmEntity) LoadTyped(reqmatch FirmLoadMatch, ctrl map[string]any) (Firm, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Firm{}, err
	}
	return typedFrom[Firm](res), nil
}



func (e *FirmEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *FirmEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *FirmEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *FirmEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *FirmEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
