...
type UmmGasControllerEntity struct {
	name    string
...
func NewUmmGasControllerEntity(client *core.EleringDashboardSDK, entopts map[string]any) *UmmGasControllerEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *UmmGasControllerEntity) GetName() string { return e.name }
...
func (e *UmmGasControllerEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *UmmGasControllerEntity) Deleted() bool {
	return e.deleted
}


func (e *UmmGasControllerEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewUmmGasControllerEntity(e.client, opts)
}

func (e *UmmGasControllerEntity) Data(args ...any) any {
...
func (e *UmmGasControllerEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an UmmGasController; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *UmmGasControllerEntity) DataTyped(data ...UmmGasController) UmmGasController {
	if len(data) > 0 {
		return typedFrom[UmmGasController](e.Data(asMap(data[0])))
	}
	return typedFrom[UmmGasController](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through UmmGasController (all fields
// optional at the wire level).
func (e *UmmGasControllerEntity) MatchTyped(match ...UmmGasController) UmmGasController {
	if len(match) > 0 {
		return typedFrom[UmmGasController](e.Match(asMap(match[0])))
	}
	return typedFrom[UmmGasController](e.Match())
}
...
func (e *UmmGasControllerEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *UmmGasControllerEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// UmmGasControllerLoadMatch and returns an UmmGasController. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *UmmGasControllerEntity) LoadTyped(reqmatch UmmGasControllerLoadMatch, ctrl map[string]any) (UmmGasController, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return UmmGasController{}, err
	}
	return typedFrom[UmmGasController](res), nil
}



func (e *UmmGasControllerEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *UmmGasControllerEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *UmmGasControllerEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *UmmGasControllerEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *UmmGasControllerEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
