...
func NewGasSystemEntity(client *core.EleringDashboardSDK, entopts map[string]any) *GasSystemEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GasSystemEntity) GetName() string { return e.name }
...
func (e *GasSystemEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GasSystemEntity) Deleted() bool {
	return e.deleted
}


func (e *GasSystemEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGasSystemEntity(e.client, opts)
}

func (e *GasSystemEntity) Data(args ...any) any {
...
func (e *GasSystemEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GasSystem; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GasSystemEntity) DataTyped(data ...GasSystem) GasSystem {
	if len(data) > 0 {
		return typedFrom[GasSystem](e.Data(asMap(data[0])))
	}
	return typedFrom[GasSystem](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GasSystem (all fields
// optional at the wire level).
func (e *GasSystemEntity) MatchTyped(match ...GasSystem) GasSystem {
	if len(match) > 0 {
		return typedFrom[GasSystem](e.Match(asMap(match[0])))
	}
	return typedFrom[GasSystem](e.Match())
}
...
func (e *GasSystemEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GasSystemEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GasSystemLoadMatch and returns an GasSystem. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *GasSystemEntity) LoadTyped(reqmatch GasSystemLoadMatch, ctrl map[string]any) (GasSystem, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return GasSystem{}, err
	}
	return typedFrom[GasSystem](res), nil
}



func (e *GasSystemEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *GasSystemEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GasSystemEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GasSystemEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GasSystemEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
