...
type SystemControllerEntity struct {
	name    string
...
func NewSystemControllerEntity(client *core.EleringDashboardSDK, entopts map[string]any) *SystemControllerEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SystemControllerEntity) GetName() string { return e.name }
...
func (e *SystemControllerEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SystemControllerEntity) Deleted() bool {
	return e.deleted
}


func (e *SystemControllerEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSystemControllerEntity(e.client, opts)
}

func (e *SystemControllerEntity) Data(args ...any) any {
...
func (e *SystemControllerEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an SystemController; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *SystemControllerEntity) DataTyped(data ...SystemController) SystemController {
	if len(data) > 0 {
		return typedFrom[SystemController](e.Data(asMap(data[0])))
	}
	return typedFrom[SystemController](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through SystemController (all fields
// optional at the wire level).
func (e *SystemControllerEntity) MatchTyped(match ...SystemController) SystemController {
	if len(match) > 0 {
		return typedFrom[SystemController](e.Match(asMap(match[0])))
	}
	return typedFrom[SystemController](e.Match())
}
...
func (e *SystemControllerEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SystemControllerEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// SystemControllerLoadMatch and returns an SystemController. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *SystemControllerEntity) LoadTyped(reqmatch SystemControllerLoadMatch, ctrl map[string]any) (SystemController, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return SystemController{}, err
	}
	return typedFrom[SystemController](res), nil
}



func (e *SystemControllerEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *SystemControllerEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *SystemControllerEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *SystemControllerEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *SystemControllerEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
