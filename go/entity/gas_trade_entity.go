...
func NewGasTradeEntity(client *core.EleringDashboardSDK, entopts map[string]any) *GasTradeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GasTradeEntity) GetName() string { return e.name }
...
func (e *GasTradeEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GasTradeEntity) Deleted() bool {
	return e.deleted
}


func (e *GasTradeEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGasTradeEntity(e.client, opts)
}

func (e *GasTradeEntity) Data(args ...any) any {
...
func (e *GasTradeEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GasTrade; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GasTradeEntity) DataTyped(data ...GasTrade) GasTrade {
	if len(data) > 0 {
		return typedFrom[GasTrade](e.Data(asMap(data[0])))
	}
	return typedFrom[GasTrade](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GasTrade (all fields
// optional at the wire level).
func (e *GasTradeEntity) MatchTyped(match ...GasTrade) GasTrade {
	if len(match) > 0 {
		return typedFrom[GasTrade](e.Match(asMap(match[0])))
	}
	return typedFrom[GasTrade](e.Match())
}
...
func (e *GasTradeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GasTradeEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GasTradeLoadMatch and returns an GasTrade. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *GasTradeEntity) LoadTyped(reqmatch GasTradeLoadMatch, ctrl map[string]any) (GasTrade, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return GasTrade{}, err
	}
	return typedFrom[GasTrade](res), nil
}



func (e *GasTradeEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *GasTradeEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GasTradeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GasTradeEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GasTradeEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
