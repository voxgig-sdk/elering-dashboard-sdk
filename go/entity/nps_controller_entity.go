...
type NpsControllerEntity struct {
	name    string
...
func NewNpsControllerEntity(client *core.EleringDashboardSDK, entopts map[string]any) *NpsControllerEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *NpsControllerEntity) GetName() string { return e.name }
...
func (e *NpsControllerEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *NpsControllerEntity) Deleted() bool {
	return e.deleted
}


func (e *NpsControllerEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewNpsControllerEntity(e.client, opts)
}

func (e *NpsControllerEntity) Data(args ...any) any {
...
func (e *NpsControllerEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *NpsControllerEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *NpsControllerEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *NpsControllerEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *NpsControllerEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *NpsControllerEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *NpsControllerEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
