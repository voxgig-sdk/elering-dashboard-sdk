...
func NewBalanceControllerEntity(client *core.EleringDashboardSDK, entopts map[string]any) *BalanceControllerEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BalanceControllerEntity) GetName() string { return e.name }
...
func (e *BalanceControllerEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *BalanceControllerEntity) Deleted() bool {
	return e.deleted
}


func (e *BalanceControllerEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewBalanceControllerEntity(e.client, opts)
}

func (e *BalanceControllerEntity) Data(args ...any) any {
...
func (e *BalanceControllerEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an BalanceController; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *BalanceControllerEntity) DataTyped(data ...BalanceController) BalanceController {
	if len(data) > 0 {
		return typedFrom[BalanceController](e.Data(asMap(data[0])))
	}
	return typedFrom[BalanceController](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through BalanceController (all fields
// optional at the wire level).
func (e *BalanceControllerEntity) MatchTyped(match ...BalanceController) BalanceController {
	if len(match) > 0 {
		return typedFrom[BalanceController](e.Match(asMap(match[0])))
	}
	return typedFrom[BalanceController](e.Match())
}
...
func (e *BalanceControllerEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *BalanceControllerEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// BalanceControllerLoadMatch and returns an BalanceController. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *BalanceControllerEntity) LoadTyped(reqmatch BalanceControllerLoadMatch, ctrl map[string]any) (BalanceController, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return BalanceController{}, err
	}
	return typedFrom[BalanceController](res), nil
}



func (e *BalanceControllerEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *BalanceControllerEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *BalanceControllerEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *BalanceControllerEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *BalanceControllerEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
