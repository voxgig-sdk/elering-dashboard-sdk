...
type UmmRssFeedControllerEntity struct {
	name    string
...
func NewUmmRssFeedControllerEntity(client *core.EleringDashboardSDK, entopts map[string]any) *UmmRssFeedControllerEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *UmmRssFeedControllerEntity) GetName() string { return e.name }
...
func (e *UmmRssFeedControllerEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *UmmRssFeedControllerEntity) Deleted() bool {
	return e.deleted
}


func (e *UmmRssFeedControllerEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewUmmRssFeedControllerEntity(e.client, opts)
}

func (e *UmmRssFeedControllerEntity) Data(args ...any) any {
...
func (e *UmmRssFeedControllerEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *UmmRssFeedControllerEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *UmmRssFeedControllerEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *UmmRssFeedControllerEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *UmmRssFeedControllerEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *UmmRssFeedControllerEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *UmmRssFeedControllerEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
