...
func NewNominationEntity(client *core.EleringDashboardSDK, entopts map[string]any) *NominationEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *NominationEntity) GetName() string { return e.name }
...
func (e *NominationEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *NominationEntity) Deleted() bool {
	return e.deleted
}


func (e *NominationEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewNominationEntity(e.client, opts)
}

func (e *NominationEntity) Data(args ...any) any {
...
func (e *NominationEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Nomination; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *NominationEntity) DataTyped(data ...Nomination) Nomination {
	if len(data) > 0 {
		return typedFrom[Nomination](e.Data(asMap(data[0])))
	}
	return typedFrom[Nomination](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Nomination (all fields
// optional at the wire level).
func (e *NominationEntity) MatchTyped(match ...Nomination) Nomination {
	if len(match) > 0 {
		return typedFrom[Nomination](e.Match(asMap(match[0])))
	}
	return typedFrom[Nomination](e.Match())
}
...
func (e *NominationEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *NominationEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// NominationLoadMatch and returns an Nomination. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *NominationEntity) LoadTyped(reqmatch NominationLoadMatch, ctrl map[string]any) (Nomination, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Nomination{}, err
	}
	return typedFrom[Nomination](res), nil
}



func (e *NominationEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *NominationEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *NominationEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *NominationEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *NominationEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
