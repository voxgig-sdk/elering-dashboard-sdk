...
type GreenControllerEntity struct {
	name    string
...
func NewGreenControllerEntity(client *core.EleringDashboardSDK, entopts map[string]any) *GreenControllerEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GreenControllerEntity) GetName() string { return e.name }
...
func (e *GreenControllerEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GreenControllerEntity) Deleted() bool {
	return e.deleted
}


func (e *GreenControllerEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGreenControllerEntity(e.client, opts)
}

func (e *GreenControllerEntity) Data(args ...any) any {
...
func (e *GreenControllerEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *GreenControllerEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GreenControllerEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *GreenControllerEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GreenControllerEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GreenControllerEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GreenControllerEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
