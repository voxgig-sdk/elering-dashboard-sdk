...
|---|---|---|
| `ts/` | @voxgig-sdk/elering-dashboard-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/elering-dashboard-sdk \
      --repository voxgig-sdk/elering-dashboard-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/elering-dashboard-sdk` shows it, and
`npm trust revoke @voxgig-sdk/elering-dashboard-sdk --id=<id>` removes it.
