...
// EleringDashboard SDK clienttrack feature
...
class EleringDashboardClienttrackFeature extends EleringDashboardBaseFeature
{
    ...
    public function PostConstruct(EleringDashboardContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'EleringDashboard-SDK';
