...
// EleringDashboard SDK streaming feature
...
class EleringDashboardStreamingFeature extends EleringDashboardBaseFeature
{
    ...
    private function _iterate(EleringDashboardResult $result): \Generator
    {
    ...
    private function _streamable(EleringDashboardContext $ctx): bool
    {
