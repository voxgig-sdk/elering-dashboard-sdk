...
// EleringDashboard SDK cache feature
...
class EleringDashboardCacheFeature extends EleringDashboardBaseFeature
{
    ...
    private function _through(EleringDashboardContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
