...
// EleringDashboard SDK utility: result_basic

class EleringDashboardResultBasic
{
    public static function call(EleringDashboardContext $ctx): ?EleringDashboardResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof EleringDashboardError) ? $result->err->msg : (string)$result->err;
