...
// EleringDashboard SDK utility: graphql
//
...
class EleringDashboardGraphql
{
    ...
    // equivalent.
    public static function body(EleringDashboardContext $ctx): mixed
    {
    ...
    public static function errors(EleringDashboardContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
