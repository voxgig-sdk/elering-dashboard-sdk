...
// EleringDashboard SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = EleringDashboardOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(EleringDashboardOmni::structfix($now, Struct::undef()))
                        !== json_encode(EleringDashboardOmni::structfix($val, Struct::undef()))) {
