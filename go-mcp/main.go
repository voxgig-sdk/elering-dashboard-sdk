// Command EleringDashboard-mcp is an MCP server exposing the EleringDashboard
// SDK as MCP tools.
//
// Two tools are registered:
//
//	EleringDashboard_list  — list records of an entity
//	EleringDashboard_load  — load a single record of an entity
//
