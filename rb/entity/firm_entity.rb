...
class FirmEntity
  ...
  # @return [Firm, Hash] the current Firm data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Firm fields)
  def match_get
  ...
  # Load a single Firm.
  #
  # @param reqmatch [FirmLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Firm.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Firm, Hash] the loaded Firm; raises EleringDashboardError on failure
