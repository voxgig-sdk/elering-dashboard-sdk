...
class NominationEntity
  ...
  def make
    opts = @_entopts.dup
    NominationEntity.new(@_client, opts)
  end
  ...
  # @return [Nomination, Hash] the current Nomination data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Nomination fields)
  def match_get
  ...
  #
  # @param reqmatch [NominationLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Nomination.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Nomination, Hash] the loaded Nomination; raises EleringDashboardError on failure
