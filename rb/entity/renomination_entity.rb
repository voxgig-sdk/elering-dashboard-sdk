...
class RenominationEntity
  ...
  def make
    opts = @_entopts.dup
    RenominationEntity.new(@_client, opts)
  end
  ...
  # @return [Renomination, Hash] the current Renomination data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Renomination fields)
  def match_get
  ...
  #
  # @param reqmatch [RenominationLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Renomination.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Renomination, Hash] the loaded Renomination; raises EleringDashboardError on failure
