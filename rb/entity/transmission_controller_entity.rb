...
class TransmissionControllerEntity
  ...
  def make
    opts = @_entopts.dup
    TransmissionControllerEntity.new(@_client, opts)
  end
  ...
  # @return [TransmissionController, Hash] the current TransmissionController data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of TransmissionController fields)
  def match_get
  ...
  #
  # @param reqmatch [TransmissionControllerLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.TransmissionController.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [TransmissionController, Hash] the loaded TransmissionController; raises EleringDashboardError on failure
