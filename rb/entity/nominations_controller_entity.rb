...
class NominationsControllerEntity
  ...
  def make
    opts = @_entopts.dup
    NominationsControllerEntity.new(@_client, opts)
  end
  ...
  # @return [NominationsController, Hash] the current NominationsController data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of NominationsController fields)
  def match_get
  ...
  #
  # @param reqmatch [NominationsControllerLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.NominationsController.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [NominationsController, Hash] the loaded NominationsController; raises EleringDashboardError on failure
