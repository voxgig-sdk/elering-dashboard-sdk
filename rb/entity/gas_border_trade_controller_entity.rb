...
class GasBorderTradeControllerEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "gas_border_trade_controller"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    GasBorderTradeControllerEntity.new(@_client, opts)
  end
  ...
  # @return [GasBorderTradeController, Hash] the current GasBorderTradeController data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of GasBorderTradeController fields)
  def match_get
  ...
  #
  # @param reqmatch [GasBorderTradeControllerLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.GasBorderTradeController.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [GasBorderTradeController, Hash] the loaded GasBorderTradeController; raises EleringDashboardError on failure
