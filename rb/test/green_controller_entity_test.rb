...
class GreenControllerEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set ELERING_DASHBOARD_TEST_GREEN_CONTROLLER_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def green_controller_basic_setup(extra)
  ...
  entid_env_raw = ENV["ELERING_DASHBOARD_TEST_GREEN_CONTROLLER_ENTID"]
