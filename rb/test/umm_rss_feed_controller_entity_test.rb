...
class UmmRssFeedControllerEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set ELERINGDASHBOARD_TEST_UMM_RSS_FEED_CONTROLLER_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def umm_rss_feed_controller_basic_setup(extra)
  ...
  entid_env_raw = ENV["ELERINGDASHBOARD_TEST_UMM_RSS_FEED_CONTROLLER_ENTID"]
