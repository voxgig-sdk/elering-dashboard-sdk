...
#      offline in seeded test mode (EleringDashboardSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "EleringDashboard_sdk.rb")
  SDK_CLASS = "EleringDashboardSDK"
