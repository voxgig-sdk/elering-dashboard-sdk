...
class NpsControllerEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return NpsControllerEntity(self._client, opts)
    ...
    def data_get(self) -> NpsController:
    ...
    def match_get(self) -> NpsController:
    ...
    def load(self, reqmatch=None, ctrl=None) -> NpsController:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.NpsController().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
