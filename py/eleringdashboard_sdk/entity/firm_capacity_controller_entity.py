...
class FirmCapacityControllerEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return FirmCapacityControllerEntity(self._client, opts)
    ...
    def data_get(self) -> FirmCapacityController:
    ...
    def match_get(self) -> FirmCapacityController:
    ...
    def load(self, reqmatch=None, ctrl=None) -> FirmCapacityController:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.FirmCapacityController().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
