...
class GasSystemControllerEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GasSystemControllerEntity(self._client, opts)
    ...
    def data_get(self) -> GasSystemController:
    ...
    def match_get(self) -> GasSystemController:
    ...
    def load(self, reqmatch=None, ctrl=None) -> GasSystemController:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.GasSystemController().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
