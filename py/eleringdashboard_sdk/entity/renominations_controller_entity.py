...
class RenominationsControllerEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return RenominationsControllerEntity(self._client, opts)
    ...
    def data_get(self) -> RenominationsController:
    ...
    def match_get(self) -> RenominationsController:
    ...
    def load(self, reqmatch=None, ctrl=None) -> RenominationsController:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.RenominationsController().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
