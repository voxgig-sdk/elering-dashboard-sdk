...
class UmmGasControllerEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return UmmGasControllerEntity(self._client, opts)
    ...
    def data_get(self) -> UmmGasController:
    ...
    def match_get(self) -> UmmGasController:
    ...
    def load(self, reqmatch=None, ctrl=None) -> UmmGasController:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.UmmGasController().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
