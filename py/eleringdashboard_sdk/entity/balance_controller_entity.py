...
class BalanceControllerEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return BalanceControllerEntity(self._client, opts)
    ...
    def data_get(self) -> BalanceController:
    ...
    def match_get(self) -> BalanceController:
    ...
    def load(self, reqmatch=None, ctrl=None) -> BalanceController:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.BalanceController().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
