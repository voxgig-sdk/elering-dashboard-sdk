...
class UmmRssFeedControllerEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return UmmRssFeedControllerEntity(self._client, opts)
    ...
    def data_get(self) -> UmmRssFeedController:
    ...
    def match_get(self) -> UmmRssFeedController:
    ...
    def load(self, reqmatch=None, ctrl=None) -> UmmRssFeedController:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.UmmRssFeedController().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
