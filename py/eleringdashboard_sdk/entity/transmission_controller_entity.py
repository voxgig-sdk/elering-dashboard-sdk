...
class TransmissionControllerEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return TransmissionControllerEntity(self._client, opts)
    ...
    def data_get(self) -> TransmissionController:
    ...
    def match_get(self) -> TransmissionController:
    ...
    def load(self, reqmatch=None, ctrl=None) -> TransmissionController:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.TransmissionController().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
