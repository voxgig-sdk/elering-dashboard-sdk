...
from eleringdashboard_sdk.eleringdashboard_types import (
...
class InterruptibleCapacityControllerEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return InterruptibleCapacityControllerEntity(self._client, opts)
    ...
    def data_get(self) -> InterruptibleCapacityController:
    ...
    def match_get(self) -> InterruptibleCapacityController:
    ...
    def load(self, reqmatch=None, ctrl=None) -> InterruptibleCapacityController:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.InterruptibleCapacityController().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
