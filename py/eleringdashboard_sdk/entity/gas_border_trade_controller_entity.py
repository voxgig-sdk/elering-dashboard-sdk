...
class GasBorderTradeControllerEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GasBorderTradeControllerEntity(self._client, opts)
    ...
    def data_get(self) -> GasBorderTradeController:
    ...
    def match_get(self) -> GasBorderTradeController:
    ...
    def load(self, reqmatch=None, ctrl=None) -> GasBorderTradeController:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.GasBorderTradeController().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
