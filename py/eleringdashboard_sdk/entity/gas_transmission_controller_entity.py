...
class GasTransmissionControllerEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GasTransmissionControllerEntity(self._client, opts)
    ...
    def data_get(self) -> GasTransmissionController:
    ...
    def match_get(self) -> GasTransmissionController:
    ...
    def load(self, reqmatch=None, ctrl=None) -> GasTransmissionController:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.GasTransmissionController().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
