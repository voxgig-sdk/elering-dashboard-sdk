...
class GreenControllerEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GreenControllerEntity(self._client, opts)
    ...
    def data_get(self) -> GreenController:
    ...
    def match_get(self) -> GreenController:
    ...
    def load(self, reqmatch=None, ctrl=None) -> GreenController:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.GreenController().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
