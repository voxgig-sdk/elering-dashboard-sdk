...
class SystemControllerEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return SystemControllerEntity(self._client, opts)
    ...
    def data_get(self) -> SystemController:
    ...
    def match_get(self) -> SystemController:
    ...
    def load(self, reqmatch=None, ctrl=None) -> SystemController:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.SystemController().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
