...
class GasTradeControllerEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GasTradeControllerEntity(self._client, opts)
    ...
    def data_get(self) -> GasTradeController:
    ...
    def match_get(self) -> GasTradeController:
    ...
    def load(self, reqmatch=None, ctrl=None) -> GasTradeController:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.GasTradeController().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
