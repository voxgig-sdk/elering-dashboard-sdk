...
class NominationsControllerEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return NominationsControllerEntity(self._client, opts)
    ...
    def data_get(self) -> NominationsController:
    ...
    def match_get(self) -> NominationsController:
    ...
    def load(self, reqmatch=None, ctrl=None) -> NominationsController:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.NominationsController().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
