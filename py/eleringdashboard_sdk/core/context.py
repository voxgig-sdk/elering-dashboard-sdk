...
from eleringdashboard_sdk.core.helpers import get_ctx_prop, to_map
...
class EleringDashboardContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = EleringDashboardControl()
        ...
        if isinstance(sp, EleringDashboardSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, EleringDashboardResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, EleringDashboardResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return EleringDashboardOperation({})
    ...
    def make_error(self, code, msg):
        return EleringDashboardError(code, msg, self)
