    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set ELERINGDASHBOARD_TEST_NPS_CONTROLLER_ENTID JSON to run live")
        client = setup["client"]
...
def _nps_controller_basic_setup(extra):
    ...
    _entid_env_raw = os.environ.get(
        "ELERINGDASHBOARD_TEST_NPS_CONTROLLER_ENTID")
    ...
    idmap_resolved = helpers.to_map(
        env.get("ELERINGDASHBOARD_TEST_NPS_CONTROLLER_ENTID"))
