# EleringDashboard SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions EleringDashboardSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both EleringDashboardSDK(...) and EleringDashboardSDK.test(...) become
#      EleringDashboardSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "eleringdashboard_sdk"
_SDK_CLASS = "EleringDashboardSDK"
...
_ENTITIES = {
    ...
    "Firm": "firm",
    "FirmCapacityController": "firm_capacity_controller",
    "GasBalanceController": "gas_balance_controller",
    "GasBorderTradeController": "gas_border_trade_controller",
    "GasSystem": "gas_system",
    "GasSystemController": "gas_system_controller",
    "GasTrade": "gas_trade",
    "GasTradeController": "gas_trade_controller",
    "GasTransmissionController": "gas_transmission_controller",
    "GreenController": "green_controller",
    "Interruptible": "interruptible",
    "InterruptibleCapacityController": "interruptible_capacity_controller",
    "Nomination": "nomination",
    "NominationsController": "nominations_controller",
    "NpsController": "nps_controller",
    "Renomination": "renomination",
    "RenominationsController": "renominations_controller",
    "System": "system",
    "SystemController": "system_controller",
    "TransmissionController": "transmission_controller",
    "UmmGasController": "umm_gas_controller",
    "UmmRssFeedController": "umm_rss_feed_controller",
}
