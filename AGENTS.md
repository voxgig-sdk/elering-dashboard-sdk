# EleringDashboard SDK — Agent Guide
...
**Entities** (24): `Balance`, `BalanceController`, `Firm`, `FirmCapacityController`, `GasBalanceController`, `GasBorderTradeController`, `GasSystem`, `GasSystemController`, `GasTrade`, `GasTradeController`, `GasTransmissionController`, `GreenController`, `Interruptible`, `InterruptibleCapacityController`, `Nomination`, `NominationsController`, `NpsController`, `Renomination`, `RenominationsController`, `System`, `SystemController`, `TransmissionController`, `UmmGasController`, `UmmRssFeedController`.
