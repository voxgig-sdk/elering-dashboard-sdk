...
// EleringDashboard SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class EleringDashboardTransformResponse
{
    public static function call(EleringDashboardContext $ctx): mixed
    {
        ...
        $transform = EleringDashboardHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
