...
// EleringDashboard SDK utility: fetcher

class EleringDashboardFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; EleringDashboardSDK/1.0)';
    ...
    public static function call(EleringDashboardContext $ctx, string $fullurl, array $fetchdef): array
    {
