...
// EleringDashboard SDK utility: make_options

class EleringDashboardMakeOptions
{
    ...
    public static function call(EleringDashboardContext $ctx): array
    {
        ...
        //
        // `EleringDashboardSchema::optspec()` is built from the model:
        ...
        $optspec = EleringDashboardSchema::optspec();
