...
// EleringDashboard SDK paging feature
...
class EleringDashboardPagingFeature extends EleringDashboardBaseFeature
{
    ...
    private function _is_list(EleringDashboardContext $ctx): bool
    {
