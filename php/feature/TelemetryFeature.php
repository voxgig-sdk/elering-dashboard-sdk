...
// EleringDashboard SDK telemetry feature
...
class EleringDashboardTelemetryFeature extends EleringDashboardBaseFeature
{
    ...
    private function _close(EleringDashboardContext $ctx, bool $ok): void
    {
