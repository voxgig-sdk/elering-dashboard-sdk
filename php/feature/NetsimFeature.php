...
// EleringDashboard SDK netsim feature
...
class EleringDashboardNetsimFeature extends EleringDashboardBaseFeature
{
    ...
    private function _simulate(EleringDashboardContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(EleringDashboardContext $ctx, array $applied): void
    {
        $client = $this->client;
