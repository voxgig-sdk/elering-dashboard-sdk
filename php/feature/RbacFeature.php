...
// EleringDashboard SDK rbac feature
...
class EleringDashboardRbacFeature extends EleringDashboardBaseFeature
{
    ...
    private function _required(EleringDashboardContext $ctx): ?string
    {
    ...
    private function _reject(EleringDashboardContext $ctx, string $required): void
    {
    ...
    private function _track(EleringDashboardContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
