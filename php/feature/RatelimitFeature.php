...
// EleringDashboard SDK ratelimit feature
...
class EleringDashboardRatelimitFeature extends EleringDashboardBaseFeature
{
    ...
    private function _acquire(EleringDashboardContext $ctx): void
    {
    ...
    private function _track(EleringDashboardContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
