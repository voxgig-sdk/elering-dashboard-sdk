...
// EleringDashboard SDK proxy feature
...
class EleringDashboardProxyFeature extends EleringDashboardBaseFeature
{
    ...
    public function init(EleringDashboardContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (EleringDashboardContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
