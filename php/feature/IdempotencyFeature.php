...
// EleringDashboard SDK idempotency feature
...
class EleringDashboardIdempotencyFeature extends EleringDashboardBaseFeature
{
    ...
    private function _mutating(EleringDashboardContext $ctx): bool
    {
