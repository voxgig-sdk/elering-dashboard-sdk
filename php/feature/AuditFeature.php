...
// EleringDashboard SDK audit feature
...
class EleringDashboardAuditFeature extends EleringDashboardBaseFeature
{
    ...
    private function _emit(EleringDashboardContext $ctx, string $outcome): void
    {
