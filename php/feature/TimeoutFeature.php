...
// EleringDashboard SDK timeout feature
...
class EleringDashboardTimeoutFeature extends EleringDashboardBaseFeature
{
    ...
    private function _with_timeout(EleringDashboardContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(EleringDashboardContext $_ctx, float $ms): void
    {
        $client = $this->client;
