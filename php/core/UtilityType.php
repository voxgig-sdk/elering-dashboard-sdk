...
// EleringDashboard SDK utility type

class EleringDashboardUtility
{
    ...
    public static function copy(EleringDashboardUtility $src): EleringDashboardUtility
    {
        $u = new EleringDashboardUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
