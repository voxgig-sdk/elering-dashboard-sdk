...
// EleringDashboard SDK GasSystem entity
...
class GasSystemEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new GasSystemEntity($this->_client, $opts);
    }

    /**
     * @param GasSystem|array $args GasSystem data (assoc-array) to store.
     */
    ...
    /**
     * @return GasSystem|array The current GasSystem data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of GasSystem fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of GasSystem fields).
     */
    ...
    /**
     * Load a single GasSystem.
     *
     * @param GasSystemLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed GasSystemLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GasSystem|array The loaded GasSystem as an assoc-array at the
