...
// EleringDashboard SDK NominationsController entity
...
class NominationsControllerEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "nominations_controller";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new NominationsControllerEntity($this->_client, $opts);
    }

    /**
     * @param NominationsController|array $args NominationsController data (assoc-array) to store.
     */
    ...
    /**
     * @return NominationsController|array The current NominationsController data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of NominationsController fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of NominationsController fields).
     */
    ...
    /**
     * Load a single NominationsController.
     *
     * @param NominationsControllerLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed NominationsControllerLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return NominationsController|array The loaded NominationsController as an assoc-array at the
