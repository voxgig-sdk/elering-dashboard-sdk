...
// EleringDashboard SDK GasBorderTradeController entity
...
class GasBorderTradeControllerEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "gas_border_trade_controller";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new GasBorderTradeControllerEntity($this->_client, $opts);
    }

    /**
     * @param GasBorderTradeController|array $args GasBorderTradeController data (assoc-array) to store.
     */
    ...
    /**
     * @return GasBorderTradeController|array The current GasBorderTradeController data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of GasBorderTradeController fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of GasBorderTradeController fields).
     */
    ...
    /**
     * Load a single GasBorderTradeController.
     *
     * @param GasBorderTradeControllerLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed GasBorderTradeControllerLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GasBorderTradeController|array The loaded GasBorderTradeController as an assoc-array at the
