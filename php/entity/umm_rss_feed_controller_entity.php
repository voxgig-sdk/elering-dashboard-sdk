...
// EleringDashboard SDK UmmRssFeedController entity
...
class UmmRssFeedControllerEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "umm_rss_feed_controller";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new UmmRssFeedControllerEntity($this->_client, $opts);
    }

    /**
     * @param UmmRssFeedController|array $args UmmRssFeedController data (assoc-array) to store.
     */
    ...
    /**
     * @return UmmRssFeedController|array The current UmmRssFeedController data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of UmmRssFeedController fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of UmmRssFeedController fields).
     */
    ...
    /**
     * Load a single UmmRssFeedController.
     *
     * @param UmmRssFeedControllerLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed UmmRssFeedControllerLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return UmmRssFeedController|array The loaded UmmRssFeedController as an assoc-array at the
