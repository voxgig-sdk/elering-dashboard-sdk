...
// EleringDashboard SDK Interruptible entity
...
class InterruptibleEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new InterruptibleEntity($this->_client, $opts);
    }

    /**
     * @param Interruptible|array $args Interruptible data (assoc-array) to store.
     */
    ...
    /**
     * @return Interruptible|array The current Interruptible data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Interruptible fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Interruptible fields).
     */
    ...
    /**
     * Load a single Interruptible.
     *
     * @param InterruptibleLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed InterruptibleLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Interruptible|array The loaded Interruptible as an assoc-array at the
