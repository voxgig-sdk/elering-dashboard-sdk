...
// EleringDashboard SDK GasTrade entity
...
class GasTradeEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new GasTradeEntity($this->_client, $opts);
    }

    /**
     * @param GasTrade|array $args GasTrade data (assoc-array) to store.
     */
    ...
    /**
     * @return GasTrade|array The current GasTrade data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of GasTrade fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of GasTrade fields).
     */
    ...
    /**
     * Load a single GasTrade.
     *
     * @param GasTradeLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed GasTradeLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GasTrade|array The loaded GasTrade as an assoc-array at the
