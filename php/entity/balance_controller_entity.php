...
// EleringDashboard SDK BalanceController entity
...
class BalanceControllerEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new BalanceControllerEntity($this->_client, $opts);
    }

    /**
     * @param BalanceController|array $args BalanceController data (assoc-array) to store.
     */
    ...
    /**
     * @return BalanceController|array The current BalanceController data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of BalanceController fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of BalanceController fields).
     */
    ...
    /**
     * Load a single BalanceController.
     *
     * @param BalanceControllerLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed BalanceControllerLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return BalanceController|array The loaded BalanceController as an assoc-array at the
