...
// EleringDashboard SDK GasSystemController entity
...
class GasSystemControllerEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "gas_system_controller";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new GasSystemControllerEntity($this->_client, $opts);
    }

    /**
     * @param GasSystemController|array $args GasSystemController data (assoc-array) to store.
     */
    ...
    /**
     * @return GasSystemController|array The current GasSystemController data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of GasSystemController fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of GasSystemController fields).
     */
    ...
    /**
     * Load a single GasSystemController.
     *
     * @param GasSystemControllerLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed GasSystemControllerLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GasSystemController|array The loaded GasSystemController as an assoc-array at the
