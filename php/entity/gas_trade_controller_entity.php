...
// EleringDashboard SDK GasTradeController entity
...
class GasTradeControllerEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "gas_trade_controller";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new GasTradeControllerEntity($this->_client, $opts);
    }

    /**
     * @param GasTradeController|array $args GasTradeController data (assoc-array) to store.
     */
    ...
    /**
     * @return GasTradeController|array The current GasTradeController data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of GasTradeController fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of GasTradeController fields).
     */
    ...
    /**
     * Load a single GasTradeController.
     *
     * @param GasTradeControllerLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed GasTradeControllerLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GasTradeController|array The loaded GasTradeController as an assoc-array at the
