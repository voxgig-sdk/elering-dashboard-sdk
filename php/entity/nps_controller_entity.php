...
// EleringDashboard SDK NpsController entity
...
class NpsControllerEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new NpsControllerEntity($this->_client, $opts);
    }

    /**
     * @param NpsController|array $args NpsController data (assoc-array) to store.
     */
    ...
    /**
     * @return NpsController|array The current NpsController data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of NpsController fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of NpsController fields).
     */
    ...
    /**
     * Load a single NpsController.
     *
     * @param NpsControllerLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed NpsControllerLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return NpsController|array The loaded NpsController as an assoc-array at the
