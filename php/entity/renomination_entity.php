...
// EleringDashboard SDK Renomination entity
...
class RenominationEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new RenominationEntity($this->_client, $opts);
    }

    /**
     * @param Renomination|array $args Renomination data (assoc-array) to store.
     */
    ...
    /**
     * @return Renomination|array The current Renomination data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Renomination fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Renomination fields).
     */
    ...
    /**
     * Load a single Renomination.
     *
     * @param RenominationLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed RenominationLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Renomination|array The loaded Renomination as an assoc-array at the
