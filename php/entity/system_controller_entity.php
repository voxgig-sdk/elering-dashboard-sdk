...
// EleringDashboard SDK SystemController entity
...
class SystemControllerEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new SystemControllerEntity($this->_client, $opts);
    }

    /**
     * @param SystemController|array $args SystemController data (assoc-array) to store.
     */
    ...
    /**
     * @return SystemController|array The current SystemController data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of SystemController fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of SystemController fields).
     */
     ...
     *
     * @param SystemControllerLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed SystemControllerLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SystemController|array The loaded SystemController as an assoc-array at the
