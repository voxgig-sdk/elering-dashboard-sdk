...
// EleringDashboard SDK GreenController entity
...
class GreenControllerEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new GreenControllerEntity($this->_client, $opts);
    }

    /**
     * @param GreenController|array $args GreenController data (assoc-array) to store.
     */
    ...
    /**
     * @return GreenController|array The current GreenController data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of GreenController fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of GreenController fields).
     */
     ...
     *
     * @param GreenControllerLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed GreenControllerLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GreenController|array The loaded GreenController as an assoc-array at the
