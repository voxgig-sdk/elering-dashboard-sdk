...
// EleringDashboard SDK FirmCapacityController entity
...
class FirmCapacityControllerEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "firm_capacity_controller";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new FirmCapacityControllerEntity($this->_client, $opts);
    }

    /**
     * @param FirmCapacityController|array $args FirmCapacityController data (assoc-array) to store.
     */
    ...
    /**
     * @return FirmCapacityController|array The current FirmCapacityController data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of FirmCapacityController fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of FirmCapacityController fields).
     */
    ...
    /**
     * Load a single FirmCapacityController.
     *
     * @param FirmCapacityControllerLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed FirmCapacityControllerLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return FirmCapacityController|array The loaded FirmCapacityController as an assoc-array at the
