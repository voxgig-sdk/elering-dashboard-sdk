...
class RenominationsControllerEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set ELERINGDASHBOARD_TEST_RENOMINATIONS_CONTROLLER_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function renominations_controller_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("ELERINGDASHBOARD_TEST_RENOMINATIONS_CONTROLLER_ENTID");
