...
// EleringDashboard SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (EleringDashboardSDK::test)
...
{
    private const SDK_CLASS = 'EleringDashboardSDK';
    ...
    private const SDK_BASE = 'eleringdashboard_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../eleringdashboard_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
