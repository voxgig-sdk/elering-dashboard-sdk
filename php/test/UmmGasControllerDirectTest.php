...
class UmmGasControllerDirectTest extends TestCase
{
    public function test_direct_load_umm_gas_controller(): void
    {
        $setup = umm_gas_controller_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-umm_gas_controller", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
