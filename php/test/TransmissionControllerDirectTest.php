...
class TransmissionControllerDirectTest extends TestCase
{
    public function test_direct_load_transmission_controller(): void
    {
        $setup = transmission_controller_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-transmission_controller", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
